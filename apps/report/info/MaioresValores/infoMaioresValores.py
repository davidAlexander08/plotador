from apps.report.info.MaioresValores.NEWAVE.infoMaioresValoresNewave import InfoMaioresValoresNewave
...
class InfoMaioresValores():
    def __init__(self, data, par_dados):
        ...
        self.lista_text = []
        self.lista_text.append("<h3>Maiores 5 Valores</h3>"+"\n")

        for modelo in set_modelos:
            if(modelo == "NEWAVE"):
                self.lista_text.append(InfoMaioresValoresNewave(data, par_dados).text_html)
            if(modelo == "DECOMP"):
