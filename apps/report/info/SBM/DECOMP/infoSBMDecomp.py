...
from apps.report.info.SBM.DECOMP.estruturas import Estruturas
from apps.indicadores.eco_indicadores import EcoIndicadores
import os
import pandas as pd

class InfoSBMDecomp(Estruturas):
    def __init__(self, data, par_dados):
        ...
        for arg in lista_argumentos: #["SUDESTE","NORDESTE"]:#
    ...
    def preenche_modelo_tabela_modelo(self,caso, arg):
        ...
        if(os.path.isfile(caso.caminho+"/sintese/ESTATISTICAS_OPERACAO_SBM.parquet")):
            ...
            if(oper_sbm['variavel'].str.contains("EARPF", case=False, na=False).any()):      
                ...
                earpf_last = oper_sbm.loc[(oper_sbm["variavel"] == "EARPF")]["valor"].iloc[-1]
