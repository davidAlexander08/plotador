...
class Conjunto:
    ...
    def executa(self, conjUnity, diretorio_saida_arg):
        ...
        for unity in conjUnity.listaUnidades:
            ...
            print( conjUnity.titulo)
            print(unity.arg.titulo)
            mapaFig = self.graficosConjunto.subplot_gera_grafico_linha_casos(mapaTemporal, conjUnity, unity, conjUnity.titulo+" "+unity.arg.titulo+" "+self.estudo)
