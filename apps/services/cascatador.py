...
class Cascatador(MetaData):
    def __init__(self, data):
        ...
        for c in self.casos:
            ...
            fig = go.Figure()
            fig.add_trace(go.Scatter(x = [no_cabeceira.x], y = [no_cabeceira.y], text =[no_cabeceira.nome], textposition="top center", mode = "markers", marker_color="rgba(0,0,255,1.0)" , marker=dict(symbol="triangle-down", size=15)))
    ...
    def add_scatter_graph(self,fig ,no, nivel):
        ...
        for pai in pais:
            ...
            fig.add_trace(go.Scatter(x = [pai.x], y = [pai.y], text=[pai.nome], text =[no_cabeceira.nome], textposition="top center", mode = "markers", marker_color="rgba(0,0,255,1.0)" , marker=dict(symbol="triangle-down", size=15)))
