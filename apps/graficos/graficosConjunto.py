...
class GraficosConjunto:
    ...
    def gera_grafico_linhas_diferentes_casos(
        ...
        fig.update_layout(legend=dict(title_font_family="Times New Roman", font=dict(size= unidade.tamanho_texto)),
                          title=dict(title_font_family="Times New Roman",font=dict(size= unidade.tamanho_texto)),
    ...
    def subplot_gera_grafico_linha_casos(
        ...
        fig_subplot.update_layout(title = dict(title = titulo, title_font_family="Times New Roman",font=dict(size= unidade.tamanho_texto)),
                                  legend=dict(title_font_family="Times New Roman", font=dict(size= unidade.tamanho_texto))
                                 )
