...
class Argumento:
    ...
    def __init__(self, listaNomes, chave, nome):
        ...
        if(listaNomes is not None): 
            ...
            if(len(listaNomes) == 10): coord_max = (3,4)
            if(len(listaNomes) == 11): coord_max = (3,4)
            if(len(listaNomes) == 12): coord_max = (3,4)
            if(len(listaNomes) == 13): coord_max = (3,5)
            if(len(listaNomes) == 14): coord_max = (4,5)
            if(len(listaNomes) == 15): coord_max = (4,5)
            if(len(listaNomes) == 16): coord_max = (3,6)
            if(len(listaNomes) == 17): coord_max = (3,6)
            if(len(listaNomes) == 18): coord_max = (3,6)
            if(len(listaNomes) == 19): coord_max = (3,7)
            if(len(listaNomes) == 20): coord_max = (3,7)
            if(len(listaNomes) == 21): coord_max = (3,7)
            if(len(listaNomes) == 22): coord_max = (3,8)
            if(len(listaNomes) == 23): coord_max = (3,8)
            if(len(listaNomes) == 24): coord_max = (3,8)
            if(len(listaNomes) == 25): coord_max = (3,9)
            if(len(listaNomes) == 26): coord_max = (3,9)
            if(len(listaNomes) == 27): coord_max = (3,9)
            listaUArg = []
