...
class Argumento:
    ...
    def __init__(self, listaNomes, chave, nome):
        ...
        if(listaNomes is not None): 
            ...
            if(len(listaNomes) == 17): coord_max = (5,4)
            if(len(listaNomes) == 18): coord_max = (5,4)
            if(len(listaNomes) == 19): coord_max = (5,4)
            if(len(listaNomes) == 20): coord_max = (5,4)
            if(len(listaNomes) == 21): coord_max = (5,5)
            if(len(listaNomes) == 22): coord_max = (5,5)
            if(len(listaNomes) == 23): coord_max = (5,5)
            if(len(listaNomes) == 24): coord_max = (5,5)
            if(len(listaNomes) == 25): coord_max = (5,5)
            listaUArg = []
